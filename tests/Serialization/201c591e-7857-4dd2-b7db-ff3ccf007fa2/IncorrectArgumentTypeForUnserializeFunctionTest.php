...
class IncorrectArgumentTypeForUnserializeFunctionTest extends TestCase
{
    ...
    public function testMyArrayInFor()
    {
        ...
        $this->assertEquals(1, $var->count(), "Expecting an array variable named `myArray` in the `for` statement.");
    }
