...
class MissingOpenParenthesisAfterUnlinkTest extends TestCase
{
    ...
    public function testNewFileInAssignment()
    {
        ...
        $this->assertEquals(1, $var->count(), "Expecting a variable named `newFile` in the assignment statement.");
    }
