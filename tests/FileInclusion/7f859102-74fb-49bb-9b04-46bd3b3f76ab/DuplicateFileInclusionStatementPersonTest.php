...
class DuplicateFileInclusionStatementPersonTest extends TestCase
{
    ...
    public function testGetAgeCall()
    {
        ...
        $this->assertEquals(1, $getAge->count(), "Expecting a 'getAge()' method call in the `display()` method of the `Person` class itself.");
    }
}