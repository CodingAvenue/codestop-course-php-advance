...
class CreateNewCustomExceptionClassPracticeMainTest extends TestCase
{
    ...
    public function testGetErrorMessageInEcho()
    {
        ...
        $this->assertEquals(1, $call->count(), "Expecting a `getErrorMessage()` method call of `fe` in the echo statement.");
    }
    ...
    public function testGetFileInEcho()
    {
        ...
        $this->assertEquals(1, $call->count(), "Expecting a `getFile()` method call of `fe` in the echo statement.");
    }
    ...
    public function testGetLineInEcho()
    {
        ...
        $this->assertEquals(1, $call->count(), "Expecting a `getLine()` method call of `fe` in the echo statement.");
    }
    ...
    public function testRequireOnceCallArgsFile()
    {
        ...
        $this->assertEquals(1, $string->count(), "Expecting a string `/FileNotFoundException.php` as an argument in the `require_once()` statement.");
    }
