...
class MissingRequireStatementMainTest extends TestCase
{
    ...
    public function testActualCode()
    {
        ...
        $expected  = "Exception caught: A negative number as a divisor is encountered in C:\\Users\\ccanda\\codestop-course-php-advanced\\answers\\CustomExceptions\\f4f2b2ec-00f9-4044-bde4-ffb76e3920db\\main.php";
    ...
    public function testDividendInReturn()
    {
        ...
        $this->assertEquals(1, $var->count(), "Expecting  vaariable named `dividend` in the `return` statement of the `divide()` function.");
    }
